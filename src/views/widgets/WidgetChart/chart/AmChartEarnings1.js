...
const AmChartEarnings1 = (props) => {
  useLayoutEffect(() => {
    var root = am5.Root.new('widget-line-chart1');
  ...
  return <div id="widget-line-chart1" className="WidgetlineChart ChartShadow" style={{ width: '100%', height: props.height }}></div>;
};
