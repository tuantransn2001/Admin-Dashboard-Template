              ...
              <Table responsive hover>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <h6 className="m-0">
                        <img className="rounded-circle  m-r-10" style={{ width: '40px' }} src={avatar2} alt="activity-user" />
                        Albert Andersen
                      </h6>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <h6 className="m-0">
                        <img className="rounded-circle  m-r-10" style={{ width: '40px' }} src={avatar3} alt="activity-user" />
                        Silje Larsen
                      </h6>
                    </td>
                    <td>
